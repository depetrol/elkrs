...
use elk_core::options::{EdgeLabelPlacement, PortSide};
use elk_graph::math::{ElkRectangle, KVector};

use crate::graph::{LGraphArena, LGraphId, LLabelId, LNodeId, LPortId};
...
pub fn process(a: &mut LGraphArena, graph: LGraphId) -> Result<(), String> {
    ...
    let vertical_layout = a
        .graph(graph)
        .properties
        .get::<elk_core::options::Direction>(&lopts::DIRECTION)
        .is_vertical();
