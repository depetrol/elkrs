...
use crate::internal_properties::{BPInfo, BPInfoId, BPInfoStore};
use crate::options_gen as lopts;
use crate::processors::long_edge_joiner;
use crate::processors::wrapping_support as ws;
        ...
        if reverse {
            ...
            for &n in nodes_to_move.iter().rev() {
                for e in a.node_incoming_edges(n) {
                    crate::lgraph_util::edge_reverse(a, graph, e, true);
