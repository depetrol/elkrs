...
use crate::compaction::edge_aware_scanline::EdgeAwareScanlineConstraintCalculation;
use crate::compaction::transformer::LGraphToCGraphTransformer;
use crate::graph::{LEdgeId, LGraphArena, LGraphId, LNodeId, NodeType};
use crate::options_gen::{self as lopts, ConstraintCalculationStrategy, GraphCompactionStrategy};
use crate::spacings;
...
pub fn process(a: &mut LGraphArena, graph: LGraphId) -> Result<(), String> {
    ...
    match strategy {
        ...
        GraphCompactionStrategy::EDGE_LENGTH => {
            ...
            crate::compaction::network_simplex_compaction::compact(
                &mut odc,
                a,
                &transformer,
                &handler,
...
impl crate::compaction::network_simplex_compaction::NsSpacings for SpecialSpacingsHandler {
    fn horizontal_spacing(&self, cg: &CGraph, n1: CNodeId, n2: CNodeId) -> f64 {
