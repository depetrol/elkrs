...
use elk_core::options::{Direction, PortSide};
use elk_graph::math::KVector;
use elk_graph::properties::EnumSet;

use crate::graph::{LEdgeId, LGraphArena, LLabelId, LNodeId, LPortId, NodeType};
...
pub(crate) fn get_individual_or_inherited(
    a: &LGraphArena,
    node: LNodeId,
    property: &elk_graph::properties::Property<f64>,
) -> f64 {
    crate::spacings::get_individual_or_default(a, node, property).unwrap_or(0.0)
}
