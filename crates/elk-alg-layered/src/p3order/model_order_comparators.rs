...
//! [`elk_core::javacompat::tim_sort`] (which calls `compare` in the exact
...
use crate::graph::{LGraphArena, LNodeId, LPortId, NodeType};
use crate::internal_properties as iprops;
use crate::internal_properties::TargetNodeModelOrder;
use crate::options_gen as lopts;
use crate::options_gen::{GroupOrderStrategy, LongEdgeOrderingStrategy, OrderingStrategy};
