...
mod tests {
    use super::*;
    use crate::graph::{LEdgeId, LNodeId, LPortId};
    ...
    fn build_two_layer_graph(
        ...
        let make_node = |a: &mut crate::graph::LGraphArena, layer, y: f64| {
        ...
        let make_port = |a: &mut crate::graph::LGraphArena,
                         node: LNodeId,
                         side: PortSide,
                         x: f64,
                         y: f64|
        ...
        let make_edge = |a: &mut crate::graph::LGraphArena, src: LPortId, tgt: LPortId| {
            let e = a.create_edge();
    ...
    fn two_layers_with_crossing_pair() {
        let mut a = crate::graph::LGraphArena::new();
