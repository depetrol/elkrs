...
pub enum PipelineStep {
    ...
    CycleBreaking(crate::options_gen::CycleBreakingStrategy),
    Layering(crate::options_gen::LayeringStrategy),
    CrossingMinimization(crate::options_gen::CrossingMinimizationStrategy),
    NodePlacement(crate::options_gen::NodePlacementStrategy),
