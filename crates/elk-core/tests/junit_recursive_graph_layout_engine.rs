...
use elk_core::engine::RecursiveGraphLayoutEngine;
use elk_core::options::{ResolvedAlgorithm, RESOLVED_ALGORITHM_TYPED};
use elk_core::options_gen::ALGORITHM;
use elk_core::providers::box_layouter::BoxLayoutProvider;
use elk_core::registry::{AlgorithmData, AlgorithmRegistry};
use elk_core::Elk;
...
fn test_empty_algorithm_id() {
    ...
    elk_core::providers::register_core_algorithms(&mut algorithms);
